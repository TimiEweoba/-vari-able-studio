...
"[project]/client/src/lib/animations.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const fadeInUp = {
    hidden: {
        opacity: 0,
        y: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 30
    },
    visible: {
        opacity: 1,
        y: 0,
...
const staggerContainer = {
    ...
    visible: {
        opacity: 1,
        transition: {
            staggerChildren: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 0.1,
            delayChildren: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 0.2
        }
    }
};
const simpleFade = {
...
"[project]/client/src/lib/projects.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=client_src_3eb53e43._.js.map